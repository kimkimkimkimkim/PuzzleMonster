...
[ResourcePath("UI/Window/Window-BattlePuzzle")]
public class BattlePuzzleWindowUIScript : DummyWindowBase
{
    ...
    public void Init()
    {
        ...
        for(var i=0; i< BOARD_HEIGHT; i++)
        {
            for(var j = 0; j < BOARD_WIDTH; j++)
            {
                ...
                BattlePuzzleManager.Instance.board[i, j] = boardPiece;
            }
        }
    ...
    public void CreateDragablePiece(int index,long id)
    {
        ...
        BattlePuzzleManager.Instance.dragablePieceList[index] = dragablePiece;
    }
