...
public class BattleDataProcessorTemp
{
    ...
    private void ExecuteActivateSkillPhase()
    {
        ...
        // ログを追加
        AddBattleLog(BattleLogType.StartAction);
    }
    ...
    private void ExecuteReflectSkillPhase()
    {
        ...
        skillEffectList.ForEach(skillEffect =>
        {
            ...
            // ログを追加
            AddBattleLog(BattleLogType.TakeAction);
    ...
    private void ActivatePassiveSkillIfNeeded(SkillTriggerType triggerType)
    {
        ...
        var battleMonsterAndSkillEffectListSetList = battleMonsterList
            .Select(b =>
            {
                ...
                var activateSkillEffectList = passiveSkill.effectList.Where(effect => IsValid(b, triggerType)).Select(effect => (SkillEffectMI)effect).ToList();
