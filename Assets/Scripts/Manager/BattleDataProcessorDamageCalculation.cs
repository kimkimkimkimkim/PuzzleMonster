...
public partial class BattleDataProcessor {
    ...
    private BattleActionValueData GetActionValue(BattleMonsterInfo doBattleMonster, BattleMonsterInfo beDoneBattleMonster, SkillEffectMI skillEffect, string skillGuid, int skillEffectIndex) {
        ...
        return new BattleActionValueData() {
            ...
            isBlocked = isBlocked,
            monsterAttributeCompatibilityType = incomingDamage.monsterAttributeCompatibilityType,
        };
    }
    ...
    private (float damage, bool isCritical, MonsterAttributeCompatibilityType monsterAttributeCompatibilityType) IncomingDamage(BattleMonsterInfo doMonster, BattleMonsterInfo beDoneMonster, SkillEffectMI skillEffect, string skillGuid, int skillEffectIndex) {
        ...
        var damage =
            ...
            * (
                ...
                * monsterAttributeCompatibilityValue                                                       // 属性相性
    ...
    private (float value, MonsterAttributeCompatibilityType monsterAttributeCompatibilityType) MonsterAttributeCompatibility(BattleMonsterInfo doBattleMonster, BattleMonsterInfo beDoneBattleMonster) {
        ...
        var monsterAttributeCompatibilityType =
            doMonster.attribute.IsAdvantageous(beDoneMonster.attribute) ? MonsterAttributeCompatibilityType.Advantage :
            doMonster.attribute.IsDisadvantage(beDoneMonster.attribute) ? MonsterAttributeCompatibilityType.Disadvantage :
            MonsterAttributeCompatibilityType.None;
        ...
        return (GetRate(rate + 100), monsterAttributeCompatibilityType);
    }
